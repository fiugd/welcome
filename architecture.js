...
const archGraph = {
	nodes:[
		...
		{id: "sw",       name: "SW",       radius:60, color: "orchid",       fx: 380, fy: 280 },
		{id: "handlers", name: "handlers", radius:40, color: "mediumpurple", fx: 280, fy: 450},
		{id: "workers",  name: "workers",  radius:40, color: "mediumpurple", fx: 380, fy: 450},
		{id: "persist",  name: "persist",  radius:40, color: "mediumpurple", fx: 480, fy: 450},

		{id: "net",   name: "network", radius:40, color: "orange",    fx:550,  fy: 280},
		{id: "ghcdn", name: "CDN",     radius:30, color: "goldenrod", fx: 700, fy: 130},
		{id: "ghgit", name: "git",     radius:30, color: "goldenrod", fx: 700, fy: 205},
		{id: "files", name: "files",   radius:30, color: "goldenrod", fx: 700, fy: 280},
		{id: "mrepo", name: "mods",    radius:30, color: "goldenrod", fx: 700, fy: 355},
		{id: "proxy", name: "proxied", radius:30, color: "goldenrod", fx: 700, fy: 430},
	],
	"links":[
