This is a "welcome" repo for the [fiug.dev](https://fiug.dev) tool.  Also, this is where I commit to when I'm making little experiments using [fiug.dev](https://fiug.dev).
